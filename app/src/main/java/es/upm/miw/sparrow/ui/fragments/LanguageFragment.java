...
public class LanguageFragment extends BaseQuizFragment implements ResultsDialog.GameResultsDialogListener, ExitQuizDialog.ExitQuizDialogListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vm = new ViewModelProvider(this).get(LanguageViewModel.class);
    ...
    public void onPlayAgainClicked() {
        ...
        if (getActivity() != null) {
            getActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.main, LanguageFragment.newInstance())
    ...
    private void renderQuestion() {
        ...
        if (q.image != null) {
            ...
            if (resId != 0) {
                ...
                image.setImageResource(R.drawable.language_quiz_image);
            }
        } else {
            image.setImageResource(R.drawable.language_quiz_image);
        }
