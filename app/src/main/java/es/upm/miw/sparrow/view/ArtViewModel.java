    ...
    public ArtViewModel(@NonNull Application application) {
        ...
        this.repo = new QuestionsRepositoryImpl(
                java.util.Arrays.asList(
                        new FirestoreQuestionsDataSource("artQuestions")
                )
        );
    }
    ...
    private void startQuestion() {
        ...
        timer = new CountDownTimer(QUESTION_MILLIS, 1_000) {
            ...
            public void onFinish() {
                ...
                selectedIndex.setValue(null);
                handler.postDelayed(ArtViewModel.this::nextQuestion, HILIGHT_MILLIS);
            }
        }.start();
    }
    ...
    public void resumeTimer(){
        ...
        timer = new CountDownTimer(millisToStart, 1_000) {
            ...
            public void onFinish() {
                locked.setValue(true);
                selectedIndex.setValue(null);
                handler.postDelayed(ArtViewModel.this::nextQuestion, timeLeftInMillis);
            }
        }.start();
    }
