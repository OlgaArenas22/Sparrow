...
public class EnglishViewModel extends AndroidViewModel {
    ...
    public EnglishViewModel(@NonNull Application application) {
        ...
        this.repo = new QuestionsRepositoryImpl(
                java.util.Arrays.asList(new EnglishVocabDataSource())
        );
    }
    ...
    private void startQuestion() {
        ...
        timer = new CountDownTimer(QUESTION_MILLIS, 1_000) {
            ...
            public void onFinish() {
                ...
                selectedIndex.setValue(null);
                handler.postDelayed(EnglishViewModel.this::nextQuestion, HILIGHT_MILLIS);
            }
        }.start();
    }
    ...
    public void resumeTimer(){
        ...
        timer = new CountDownTimer(millisToStart, 1_000) {
            ...
            public void onFinish() {
                locked.setValue(true);
                selectedIndex.setValue(null);
                handler.postDelayed(EnglishViewModel.this::nextQuestion, timeLeftInMillis);
            }
        }.start();
    }
