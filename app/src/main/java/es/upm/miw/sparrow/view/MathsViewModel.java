...
public class MathsViewModel extends AndroidViewModel {
    ...
    public MathsViewModel(@NonNull Application application) {
        super(application);
        this.repo = new QuestionsRepositoryImpl(
                Arrays.asList(new OpenTdbDataSource())
        );
    }
    ...
    private void startQuestion() {
        ...
        timer = new CountDownTimer(QUESTION_MILLIS, 1_000) {
            ...
            public void onFinish() {
                ...
                selectedIndex.setValue(null);
                handler.postDelayed(MathsViewModel.this::nextQuestion, HILIGHT_MILLIS);
            }
        }.start();
    }
    ...
    private void saveResult() {
        ...
        matchData.put("category", "Matemáticas");
