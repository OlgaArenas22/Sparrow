...
import es.upm.miw.sparrow.view.ArtViewModel;

public class ArtFragment extends BaseQuizFragment implements ResultsDialog.GameResultsDialogListener, ExitQuizDialog.ExitQuizDialogListener {

    private static final int MILLIS = 10 * 1000;

    private ArtViewModel vm;
    ...
    public static ArtFragment newInstance() { return new ArtFragment(); }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vm = new ViewModelProvider(this).get(ArtViewModel.class);
    ...
    public void onPlayAgainClicked() {
        ...
        if (getActivity() != null) {
            getActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.main, ArtFragment.newInstance())
                    .addToBackStack("art")
    ...
    private void renderQuestion() {
        ...
        if (q.image != null) {
            ...
            if (resId != 0) {
                ...
                image.setImageResource(R.drawable.art_quiz_image);
            }
        } else {
            image.setImageResource(R.drawable.art_quiz_image);
        }
